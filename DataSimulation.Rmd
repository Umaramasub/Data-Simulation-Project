...
generateDataset<-function(N){
  ...
  # Physical activity is a factor variable with 4 levels. This level is again dependent os the functional          #limitation. More the functional limitation, less the the level of physical activity. This was divided based
